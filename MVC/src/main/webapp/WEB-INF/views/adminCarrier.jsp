		...
		<div class="container-fluid">
			<div class="collapse navbar-collapse" id="">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/carrier"><b>Carrier</b></a><span
...
<div class="row-fluid">
		...
		<form:form action="/admin/carrier" class="form-inline" method="get" modelAttribute="filter">
		...
		<div class="col-md-12 col-xs-12">
			<form:form action="/admin/carrier" method="post" class="form-inline" 
				modelAttribute="carrier">
				<form:hidden path="id" />
				<custom:hiddenInputs excludeParams="name, id"/>
				<div class="form-group">
					<form:input id="carrier" path="name" placeholder="carrier name" class="form-control" />
					<label for="name"><form:errors path="name" /></label>
					<button type="submit" class="btn btn-primary">Create Carrier</button>
				</div>
			</form:form>
		</div>
			<div class="col-md-4 col-xs-4"><h4>Carrier name</h4></div>
			<div class="col-md-4 col-xs-4"><h4>Delete</h4></div>
			<div class="col-md-4 col-xs-4"><h4>Update</h4></div>
			<c:forEach items="${page.content}" var="carrier">
				<div class="col-md-4 col-xs-4">${carrier.name}</div>
				<div class="col-md-4 col-xs-4">
					<a href="/admin/carrier/delete/${carrier.id}<custom:allParams/>">delete</a>
				</div>
				<div class="col-md-4 col-xs-4">
					<a href="/admin/carrier/update/${carrier.id}<custom:allParams/>">update</a>
				</div>
			</c:forEach>
